...
const Forecast2yo3yoEnhanced = () => {
  ...
  // Polynomial model coefficients (SPS² term added)
  const modelCoefficients = {
    intercept:    242.678906,
    spsAvg:      -191.058114,
    slAvg:         -0.765497,
    distance2yo:    0.918761,
    spsSquared:    38.571733
  };

  const modelRSquared = 0.7959;
  const modelN = 238;
  ...
  // Min SPS adjustment — unchanged from deployed version
  ...
  // Polynomial prediction: intercept + b1*SPS + b2*SL + b3*dist2yo + b4*SPS²
